...
if ( $row_content_width === 'grid' ) {
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . wanderland_mikado_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
	$mkdf_row_wrapper_end   .= '</div></div>';
}

$mkdf_after_wrapper_open   = apply_filters('wanderland_mikado_filter_vc_after_wrapper_open', '', $atts);
$mkdf_before_wrapper_close = apply_filters('wanderland_mikado_filter_vc_before_wrapper_close', '', $atts);
$css_classes                = apply_filters('wanderland_mikado_filter_vc_css_classes', $css_classes, $atts);
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . wanderland_mikado_get_inline_style( $mkdf_vc_row_styles ) . '>';
...
echo wanderland_mikado_get_module_part( $output );
