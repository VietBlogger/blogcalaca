...
namespace WanderlandCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'wanderland' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'wanderland' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'wanderland' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'wanderland' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'wanderland' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'wanderland' ),
							'value'      => array(
								esc_html__( 'Default', 'wanderland' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'wanderland' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'wanderland' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = wanderland_mikado_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
	...
	public function getTextWrapperStyles( $params ) {
		...
		if ( $params['info_bottom_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . wanderland_mikado_filter_px( $params['info_bottom_margin'] ) . 'px';
		}
