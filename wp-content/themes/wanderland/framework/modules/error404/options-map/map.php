...
if ( ! function_exists( 'wanderland_mikado_error_404_options_map' ) ) {
	function wanderland_mikado_error_404_options_map() {
		
		wanderland_mikado_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'wanderland' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = wanderland_mikado_add_admin_panel(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'wanderland' )
			)
		);
		...
		$panel_404_options = wanderland_mikado_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'wanderland' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'wanderland' )
			)
		);
		...
		$first_level_group = wanderland_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'wanderland' )
			)
		);
        ...
        $first_level_group_responsive = wanderland_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'wanderland' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'wanderland' )
            )
        );
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'wanderland' )
			)
		);
		...
		$second_level_group = wanderland_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'wanderland' )
			)
		);
        ...
        $second_level_group_responsive = wanderland_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'wanderland' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'wanderland' )
            )
        );
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'wanderland' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'wanderland' )
			)
		);
		...
		$third_level_group = wanderland_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'wanderland' )
			)
		);
        ...
        $third_level_group_responsive = wanderland_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'wanderland' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'wanderland' )
            )
        );
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'wanderland' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'wanderland' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'wanderland' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'wanderland' ),
					'light-style' => esc_html__( 'Light', 'wanderland' )
				)
			)
		);
	}
	
	add_action( 'wanderland_mikado_action_options_map', 'wanderland_mikado_error_404_options_map', wanderland_mikado_set_options_map_position( '404' ) );
}