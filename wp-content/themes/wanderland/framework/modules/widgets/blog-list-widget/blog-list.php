...
if ( class_exists( 'WanderlandCoreClassWidget' ) ) {
	class WanderlandMikadoClassBlogListWidget extends WanderlandCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_blog_list_widget',
				esc_html__( 'Wanderland Blog List Widget', 'wanderland' ),
				array( 'description' => esc_html__( 'Display a list of your blog posts', 'wanderland' ) )
			);
			...
			$this->params = array(
				...
				array(
					...
					'options' => array(
						...
						'minimal' => esc_html__( 'Minimal', 'wanderland' )
					)
				),
				array(
					'type'  => 'textfield',
					'name'  => 'number_of_posts',
					'title' => esc_html__( 'Number of Posts', 'wanderland' )
				),
				array(
					'type'    => 'dropdown',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'orderby',
					'title'   => esc_html__( 'Order By', 'wanderland' ),
					'options' => wanderland_mikado_get_query_order_by_array()
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'order',
					'title'   => esc_html__( 'Order', 'wanderland' ),
					'options' => wanderland_mikado_get_query_order_array()
				),
				array(
					'type'        => 'textfield',
					'name'        => 'category',
					'title'       => esc_html__( 'Category Slug', 'wanderland' ),
					'description' => esc_html__( 'Leave empty for all or use comma for list', 'wanderland' )
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'title_tag',
				...
				array(
					...
					'title'   => esc_html__( 'Title Text Transform', 'wanderland' ),
		...
		public function widget( $args, $instance ) {
			...
			echo '<div class="widget mkdf-blog-list-widget" ' . wanderland_mikado_get_inline_style( $widget_styles ) . '>';
