 ...
 * Class HeaderMinimal
 */
class HeaderBottomMinimal extends HeaderType {
	...
	public function __construct() {
		$this->slug = 'header-bottom-minimal';
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters = apply_filters( 'wanderland_mikado_filter_header_bottom_minimal_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		if ( $menuAreaTransparent ) {
			...
			if ( ( $sliderExists && wanderland_mikado_is_top_bar_enabled() )
			     || wanderland_mikado_is_top_bar_enabled() && wanderland_mikado_is_top_bar_transparent()
			) {
