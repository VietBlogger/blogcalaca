...
if ( ! function_exists( 'wanderland_mikado_vertical_menu_styles' ) ) {
	function wanderland_mikado_vertical_menu_styles() {
		...
		$vertical_background_color = wanderland_mikado_options()->getOptionValue( 'vertical_header_background_color' );
		$vertical_background_image = wanderland_mikado_options()->getOptionValue( 'vertical_header_background_image' );
		$vertical_shadow_enabled   = wanderland_mikado_options()->getOptionValue( 'vertical_header_shadow' );
		$vertical_border_enabled   = wanderland_mikado_options()->getOptionValue( 'vertical_header_border' );
		...
		if ( $vertical_border_enabled === 'yes' ) {
			$header_border_color = wanderland_mikado_options()->getOptionValue( 'vertical_header_border_color' );
		...
		echo wanderland_mikado_dynamic_css( $vertical_header_selectors, $vertical_header_styles );
	}
	
	add_action( 'wanderland_mikado_action_style_dynamic', 'wanderland_mikado_vertical_menu_styles' );
}

if ( ! function_exists( 'wanderland_mikado_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function wanderland_mikado_vertical_main_menu_styles() {
		$menu_holder_styles = array();
		
		$menu_top_margin    = wanderland_mikado_options()->getOptionValue( 'vertical_menu_top_margin' );
		$menu_bottom_margin = wanderland_mikado_options()->getOptionValue( 'vertical_menu_bottom_margin' );
		
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = wanderland_mikado_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = wanderland_mikado_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo wanderland_mikado_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'wanderland_mikado_action_style_dynamic', 'wanderland_mikado_vertical_main_menu_styles' );
}