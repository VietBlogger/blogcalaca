...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = wanderland_mikado_vertical_header_holder_class();
		
		$parameters = apply_filters( 'wanderland_mikado_filter_header_vertical_parameters', $parameters );
