...
if ( ! function_exists( 'wanderland_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function wanderland_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'wanderland_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'wanderland_mikado_header_main_navigation_options_map' ) ) {
	function wanderland_mikado_header_main_navigation_options_map() {
		$hide_dep_options = wanderland_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = wanderland_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'wanderland' ),
		...
		wanderland_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'wanderland' )
			)
		);
		...
		$drop_down_group = wanderland_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'wanderland' )
			)
		);
		
		$drop_down_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'wanderland' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'wanderland' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'wanderland' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'wanderland' )
				)
			)
		);
		...
		$first_level_group = wanderland_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'wanderland' ),
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'wanderland' ),
			)
		);
		
		$first_level_row4 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'wanderland' ),
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'wanderland' ),
			)
		);
		
		$first_level_row5 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = wanderland_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'wanderland' )
			)
		);
		...
		$second_level_wide_group = wanderland_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'wanderland' )
			)
		);
		
		$second_level_wide_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = wanderland_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'wanderland' )
			)
		);
		
		$third_level_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		$third_level_row2 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = wanderland_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'wanderland' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'wanderland' )
			)
		);
		
		$third_level_wide_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = wanderland_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'wanderland_mikado_action_header_main_navigation_options_map', 'wanderland_mikado_header_main_navigation_options_map', 10, 1 );
}