        ...
        <div class="mkdf-sp-table-cell">
            <div class="mkdf-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="mkdf-sp-background" <?php wanderland_mikado_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="mkdf-sp-prevent">
			                <div class="mkdf-sp-prevent-inner">
				                ...
				                <label class="mkdf-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'wanderland' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>
