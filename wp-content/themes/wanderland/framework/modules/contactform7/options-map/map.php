...
if ( ! function_exists('wanderland_mikado_contact_form_7_options_map') ) {

	function wanderland_mikado_contact_form_7_options_map() {
		
		wanderland_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'wanderland' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = wanderland_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'wanderland' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'wanderland' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'wanderland' ),
		));
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'wanderland' ),
			)
		);
		...
		$typography_text_row2 = wanderland_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = wanderland_mikado_add_admin_row(
			array(
		...
		$typography_label_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'wanderland' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = wanderland_mikado_add_admin_row(
			array(
		...
		$background_border_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'wanderland' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'wanderland' )
			)
		);
		
		$background_border_row2 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'wanderland' ),
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'wanderland' )
			)
		);
		
		$background_border_row3 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'wanderland' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = wanderland_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'wanderland' ),
				'description' => esc_html__( 'Setup form elements margin', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = wanderland_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'wanderland' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'wanderland' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'wanderland' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'wanderland' ),
				'description' => esc_html__( 'Setup button text typography', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = wanderland_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = wanderland_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'wanderland' ),
				'description' => esc_html__( 'Setup button background and border style', 'wanderland' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'wanderland' )
			)
		);
		
		$button_background_border_row2 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'wanderland' )
			)
		);
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'wanderland' )
			)
		);
		
		$button_background_border_row3 = wanderland_mikado_add_admin_row(
			array(
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'wanderland' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		wanderland_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'wanderland' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = wanderland_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'wanderland')
		));

		//Text Typography

		$typography_text_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'wanderland'),
			'description'	=> esc_html__('Setup typography for form elements text', 'wanderland'),
		...
		$typography_text_row1 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'wanderland'),
			'description'	=> esc_html__('Setup typography for form elements label', 'wanderland'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'wanderland'),
			'description'	=> esc_html__('Setup form elements background and border style', 'wanderland'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'wanderland'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = wanderland_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'wanderland'),
			'description'	=> esc_html__('Setup form elements margin', 'wanderland'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = wanderland_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'wanderland'),
			'description'	=> esc_html__('Setup button text typography', 'wanderland'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = wanderland_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'wanderland'),
			'description'	=> esc_html__('Setup button background and border style', 'wanderland'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = wanderland_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = wanderland_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'wanderland')
        ));
        ...
        $typography_label_row3 = wanderland_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = wanderland_mikado_add_admin_row(array(
	...
	add_action( 'wanderland_mikado_action_options_map', 'wanderland_mikado_contact_form_7_options_map', wanderland_mikado_set_options_map_position( 'contact_form_7' ) );
}