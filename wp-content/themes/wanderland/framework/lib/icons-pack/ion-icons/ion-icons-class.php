...
if ( ! function_exists( 'wanderland_mikado_add_ion_icon_pack' ) ) {
	function wanderland_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new WanderlandMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_ion_icon_pack_option' ) ) {
	function wanderland_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_ion_icon_pack_option' );
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_social_options', 'wanderland_mikado_add_ion_icon_pack_option' );
}

class WanderlandMikadoClassIonIcons implements iWanderlandMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
	...
	public function getBackToTopIcon() {
		...
		return $this->render('ion-ios-arrow-thin-up');
	}
