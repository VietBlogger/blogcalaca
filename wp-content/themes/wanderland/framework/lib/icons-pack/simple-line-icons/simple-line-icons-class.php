...
if ( ! function_exists( 'wanderland_mikado_add_simple_line_icon_pack' ) ) {
	function wanderland_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new WanderlandMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_simple_line_icon_pack_option' ) ) {
	function wanderland_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_social_options', 'wanderland_mikado_add_simple_line_icon_pack_option' );
}

class WanderlandMikadoClassSimpleLineIcons implements iWanderlandMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'wanderland'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'wanderland'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'wanderland'),
            'icon-social-facebook'    => esc_html__('Facebook', 'wanderland'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'wanderland'),
            'icon-social-github'      => esc_html__('Github', 'wanderland'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'wanderland'),
            'icon-social-instagram'   => esc_html__('Instagram', 'wanderland'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'wanderland'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'wanderland'),
            'icon-social-reddit'      => esc_html__('Reddit', 'wanderland'),
            'icon-social-skype'       => esc_html__('Skype', 'wanderland'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'wanderland'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'wanderland'),
            'icon-social-spotify'     => esc_html__('Spotify', 'wanderland'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'wanderland'),
            'icon-social-twitter'     => esc_html__('Twitter', 'wanderland'),
            'icon-social-youtube'     => esc_html__('Youtube', 'wanderland')
        );
    }
