...
if ( ! function_exists( 'wanderland_mikado_add_dripicons_icon_pack' ) ) {
	function wanderland_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new WanderlandMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_dripicons_icon_pack_option' ) ) {
	function wanderland_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_dripicons_icon_pack_option' );
}

class WanderlandMikadoClassDripicons implements iWanderlandMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
