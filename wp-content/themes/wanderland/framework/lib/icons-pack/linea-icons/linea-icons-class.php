...
if ( ! function_exists( 'wanderland_mikado_add_linea_icon_pack' ) ) {
	function wanderland_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new WanderlandMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_linea_icon_pack_option' ) ) {
	function wanderland_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_linea_icon_pack_option' );
}

class WanderlandMikadoClassLineaIcons implements iWanderlandMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
