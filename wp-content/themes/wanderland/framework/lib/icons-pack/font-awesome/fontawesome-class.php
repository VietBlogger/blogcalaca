...
if ( ! function_exists( 'wanderland_mikado_add_font_awesome_icon_pack' ) ) {
	function wanderland_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new WanderlandMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_font_awesome_icon_pack_option' ) ) {
	function wanderland_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_social_options', 'wanderland_mikado_add_font_awesome_icon_pack_option' );
}

class WanderlandMikadoClassIconsFontAwesome implements iWanderlandMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/font-awesome/css/fontawesome-all.min.css';
	}
	...
	private function getNewIconsArray( $brandsIcons = false ) {
		...
		$iconsArray = array();
		$icons      = json_decode( $wp_filesystem->get_contents( WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT_DIR . '/font-awesome/icons.json' ) );
