...
if ( ! function_exists( 'wanderland_mikado_add_linear_icon_pack' ) ) {
	function wanderland_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new WanderlandMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_linear_icon_pack_option' ) ) {
	function wanderland_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_linear_icon_pack_option' );
}

class WanderlandMikadoClassLinearIcons implements iWanderlandMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
