...
if ( ! function_exists( 'wanderland_mikado_add_font_elegant_icon_pack' ) ) {
	function wanderland_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new WanderlandMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_collection', 'wanderland_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'wanderland_mikado_add_font_elegant_icon_pack_option' ) ) {
	function wanderland_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'wanderland' );
		
		return $options;
	}
	
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_options', 'wanderland_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'wanderland_mikado_filter_add_icon_pack_into_social_options', 'wanderland_mikado_add_font_elegant_icon_pack_option' );
}

class WanderlandMikadoClassIconsFontElegant implements iWanderlandMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = WANDERLAND_MIKADO_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
