...
/*
   Class: WanderlandMikadoClassDashboardForm
   A class that initializes Mikado Dashboard Container
*/

class WanderlandMikadoClassDashboardForm implements iWanderlandMikadoInterfaceLayoutNode, iWanderlandMikadoInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: WanderlandMikadoClassDashboardGroup
   A class that initializes WanderlandMikadoClass Group Field
*/
class WanderlandMikadoClassDashboardGroup implements iWanderlandMikadoInterfaceLayoutNode, iWanderlandMikadoInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: WanderlandMikadoClassDashboardTitle
   A class that initializes Dashboard Title
*/
class WanderlandMikadoClassDashboardTitle implements iWanderlandMikadoInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: WanderlandMikadoClassDashboardField
   A class that initializes WanderlandMikadoClass Front Field
*/
class WanderlandMikadoClassDashboardField implements iWanderlandMikadoInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class WanderlandMikadoClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class WanderlandMikadoClassDashboardFieldText extends WanderlandMikadoClassDashboardFieldType {
...
class WanderlandMikadoClassDashboardFieldTextArea extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class WanderlandMikadoClassDashboardFieldImage extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="mkdf-dashboard-gallery-holder">
				<ul class="mkdf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo wanderland_mikado_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="mkdf-dashboard-gallery-uploader">
					<?php
					if ( wanderland_membership_theme_installed() ) {
						echo wanderland_mikado_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'wanderland' ),
							'custom_class' => 'mkdf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-dashboard-gallery-upload"><span class="mkdf-btn-text">' . esc_html__( 'Upload', 'wanderland' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="mkdf-btn mkdf-btn-solid mkdf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'wanderland' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class WanderlandMikadoClassDashboardFieldGallery extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class WanderlandMikadoClassDashboardFieldSelect extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class WanderlandMikadoClassDashboardFieldDate extends WanderlandMikadoClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class WanderlandMikadoClassDashboardFieldIcon extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = wanderland_mikado_icon_collections()->getIconCollectionsEmpty();
...
class WanderlandMikadoClassDashboardFieldColor extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class WanderlandMikadoClassDashboardFieldCheckBoxGroup extends WanderlandMikadoClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class WanderlandMikadoClassDashboardFieldAddress extends WanderlandMikadoClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class WanderlandMikadoClassDashboardRepeater implements iWanderlandMikadoInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="mkdf-dashboard-repeater-table-heading">
					<div class="mkdf-dashboard-repeater-fields-holder">
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'wanderland' ) ?></div>
						...
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'wanderland' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class WanderlandMikadoClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new WanderlandMikadoClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new WanderlandMikadoClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new WanderlandMikadoClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new WanderlandMikadoClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new WanderlandMikadoClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new WanderlandMikadoClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new WanderlandMikadoClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new WanderlandMikadoClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new WanderlandMikadoClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new WanderlandMikadoClassDashboardFieldAddress();
