<?php
if ( ! function_exists( 'wanderland_mikado_init_google_fonts_array' ) ) {
    function wanderland_mikado_init_google_fonts_array() {
...
';
        ...
        $wanderland_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'wanderland_mikado_init_google_fonts_array');
}