<div class="mkdf-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="mkdf-testimonials mkdf-owl-custom-slider mkdf-testimonials-main" <?php echo wanderland_mikado_get_inline_attrs( $data_attr ) ?>>
    ...
    <div class="mkdf-testimonial-image-nav mkdf-owl-custom-slider">
        <?php foreach ($pagination_images as $image) { ?>
            <div class="mkdf-testimonial-image"><?php echo wanderland_mikado_get_module_part($image); ?></div>
        <?php } ?>
    </div>
