...
namespace WanderlandCore\CPT;

use WanderlandCore\Lib;

/**
 * Class PostTypesLoader
 * @package WanderlandCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'wanderland_core_filter_register_custom_post_types', $cpt_class_name = array() );
