<?php
namespace WanderlandCore\CPT\Shortcodes\Highlight;
...
class Highlight implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$html = wanderland_core_get_shortcode_module_template_part( 'templates/highlight-template', 'highlight', '', $params );
