<?php
namespace WanderlandCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'wanderland-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'wanderland-core' ),
							'value'       => array(
								esc_html__( 'Default Center', 'wanderland-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'wanderland-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'wanderland-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'wanderland-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = wanderland_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );
