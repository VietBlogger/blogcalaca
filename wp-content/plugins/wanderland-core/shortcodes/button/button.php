<?php
namespace WanderlandCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'wanderland-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									...
									esc_html__( 'Simple', 'wanderland-core' )  => 'simple'
								),
								'admin_label' => true
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'size',
								'heading'    => esc_html__( 'Size', 'wanderland-core' ),
								'value'      => array(
									esc_html__( 'Default', 'wanderland-core' ) => '',
									esc_html__( 'Small', 'wanderland-core' )   => 'small',
									esc_html__( 'Medium', 'wanderland-core' )  => 'medium',
									esc_html__( 'Large', 'wanderland-core' )   => 'large',
									esc_html__( 'Huge', 'wanderland-core' )    => 'huge'
								),
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'wanderland-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						wanderland_mikado_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'        => 'dropdown',
								'param_name'  => 'enable_svg_icon',
								'heading'     => esc_html__( 'Enable Predefined SVG Icon', 'wanderland-core' ),
							...
							array(
								...
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'wanderland-core' ),
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Hover Background Color', 'wanderland-core' ),
								'dependency' => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Border Color', 'wanderland-core' ),
								'dependency' => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Hover Border Color', 'wanderland-core' ),
								'dependency' => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'wanderland-core' ),
								'group'      => esc_html__( 'Design Options', 'wanderland-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'margin',
								'heading'     => esc_html__( 'Margin', 'wanderland-core' ),
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'wanderland-core' ),
								'description' => esc_html__( 'Insert padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'wanderland-core' ),
								'dependency'  => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'       => esc_html__( 'Design Options', 'wanderland-core' )
							)
						)
	...
	public function render( $atts, $content = null ) {
		...
		return wanderland_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
	...
	private function getButtonStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			$styles[] = 'font-size: ' . wanderland_mikado_filter_px( $params['font_size'] ) . 'px';
		}
	...
	private function getButtonClasses( $params ) {
		...
		if ( $params['enable_svg_icon'] === 'yes'  ) {
			$buttonClasses[] = 'mkdf-btn-svg-icon';
		}
