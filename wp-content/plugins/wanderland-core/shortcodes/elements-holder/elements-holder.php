...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'wanderland-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'wanderland-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'wanderland-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'wanderland-core' )  => 'one-column',
								esc_html__( '2 Columns', 'wanderland-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'wanderland-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'wanderland-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'wanderland-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'wanderland-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'wanderland-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Never', 'wanderland-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'wanderland-core' ),
							'value'       => array(
								esc_html__( 'Default', 'wanderland-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'wanderland-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . wanderland_mikado_get_class_attribute( $holder_classes ) . ' ' . wanderland_mikado_get_inline_attr( $holder_styles, 'style' ) . '>';
