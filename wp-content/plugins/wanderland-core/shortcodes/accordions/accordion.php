<?php
namespace WanderlandCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'wanderland-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'wanderland-core' ) => 'accordion',
								esc_html__( 'Toggle', 'wanderland-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'wanderland-core' ),
							'value'      => array(
								esc_html__( 'Default', 'wanderland-core' ) => '',
								esc_html__( 'White', 'wanderland-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = wanderland_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
