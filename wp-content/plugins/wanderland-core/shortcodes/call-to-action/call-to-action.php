<?php
namespace WanderlandCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'wanderland-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'wanderland-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'wanderland-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'wanderland-core' ),
							'value'      => array(
								esc_html__( '80/20', 'wanderland-core' ) => '80',
								esc_html__( '75/25', 'wanderland-core' ) => '75',
								esc_html__( '66/33', 'wanderland-core' ) => '66',
								esc_html__( '50/50', 'wanderland-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'wanderland-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = wanderland_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . wanderland_mikado_filter_px( $params['button_top_margin'] ) . 'px';
		}
