<?php
namespace WanderlandCore\CPT\Shortcodes\SplitSection;
...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Split Section', 'wanderland-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'wanderland-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'wanderland-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Text', 'wanderland-core' )    => 'simple'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'wanderland-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'wanderland-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'wanderland-core' ),
							'dependency' => array( 'element' => 'button_type', 'value' => array( 'solid' ) ),
							'group'      => esc_html__( 'Button Style', 'wanderland-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Border Color', 'wanderland-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'wanderland-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Border Color', 'wanderland-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'wanderland-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'wanderland-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'wanderland-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'wanderland-core' ),
							'value'       => array(
								esc_html__( 'Never', 'wanderland-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'wanderland-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = wanderland_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( wanderland_mikado_string_ends_with( $params['text_top_margin'], '%' ) || wanderland_mikado_string_ends_with( $params['text_top_margin'], 'px' ) ) {
