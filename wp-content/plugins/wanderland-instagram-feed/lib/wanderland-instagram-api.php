...
include 'wanderland-instagram-helper.php';

/**
 * Class WanderlandInstagramApi
 */
class WanderlandInstagramApi {
	...
	const INSTAGRAM_CODE = 'wanderland_instagram_code';
	const INSTAGRAM_USER_ID = 'wanderland_instagram_user_id';
	const INSTAGRAM_TOKEN = 'wanderland_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'wanderland_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'wanderland_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'wanderland_facebook_code';
	const FACEBOOK_TOKEN = 'wanderland_facebook_access_token';

	const CONNECTION_TYPE = 'wanderland_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new WanderlandInstagramHelper();
	}
	...
	/**
	 * @return WanderlandInstagramHelper
	 */
	 ...
	 *
	 * @see WanderlandInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see WanderlandInstagramApi::instagramExchangeCodeForToken()
	 */
