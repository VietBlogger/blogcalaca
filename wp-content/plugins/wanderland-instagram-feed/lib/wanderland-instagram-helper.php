...
/**
 * Class WanderlandInstagramHelper
 */
class WanderlandInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines wanderland_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'wanderland_instagram_image_atts',
			array(
